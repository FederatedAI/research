...
class NetworkChexpert_A(nn.Module):

    def __init__(self, C, num_classes, layers, auxiliary, genotype, u_dim=64, k=2):
        super(NetworkChexpert_A, self).__init__()
        self._layers = layers
...
class NetworkChexpert_B(nn.Module):

    def __init__(self, C, layers, auxiliary, genotype, u_dim=64):
        super(NetworkChexpert_B, self).__init__()
        self._layers = layers
        self._auxiliary = auxiliary
